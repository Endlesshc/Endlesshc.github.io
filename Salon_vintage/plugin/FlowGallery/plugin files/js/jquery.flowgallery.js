/*! Flow Gallery - Multimedia jQuery gallery plugin - 1.6
...
(function($, document, window) {
    ...
    var FlowGallery = {
        ...
        backToAlbums: function() {
            ...
            self.options.loadItemChunks && self.$addButton.css('display', 'none');
        ...
        showGallery: function() {
            ...
            $items.velocity(transition,
            {
                ...
                stagger: stagger,
                complete: function() {
                    self.options.loadItemChunks && self.options.loadChunksOnScroll && self.setupAutoChunkLoading();
                }
            });
        },
